...
.center[<img src="Figures/stockholm_coefplot.png" width="62%">]

.pull-left-wide[
- Bengtsson & Molinder (2024): 3,271 taxpayers, income *and* gender observed. Pretend gender is unobserved and predict it from **names** (Naive Bayes, 81% accuracy)
- **Naive ML is confident but wrong:** $-0.71$ vs. oracle $-0.82$. Errors are systematic: naming correlates with social status
- **Labeled-only** (random 10%, $n = 326$) is unbiased but the CI is $3\times$ wider
]

.pull-right-narrow[
.small123[*Coefficient on female, log labor income. Bars: 95% CI. Dashed line: oracle. The classifier has 97.6% precision but 67.2% recall: it misclassifies a third of women as men.* [Setup in detail](#stockholm-setup)]
]
...
# When can the bias be corrected? A taxonomy
...
.pull-left[
.center[<img src="Figures/cost.png" width="70%">]
]
.pull-right[
**How many hours would this take by hand?**

- Hours to tens: type it yourself
- Hundreds to thousands: off-the-shelf LLM / VLM
- Thousands+: build your own; released openly it becomes an off-the-shelf tool for the field
- Research-ready includes validation and debiasing, so no project is fully automated
...
.footnote[.left[.small123[[Back to slides](#example)]]]
