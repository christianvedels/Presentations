...
.huge123[
## Glem alt om store sprogmodeller: 
### Her er hvad vi kan gøre med små sprogmodeller 
]
...
<br>
.pull-left-wide[
# Denne præsentation handler ikke om...
- ...at bruge AI som *økonomisk model* til at forudsige konjukturer el lign.
- ...at bruge AI som forbruger (f.eks. workflows i chatGPT)
]
...
.pull-left-wide[
### *Denne præsentation*
- Hvordan kan vi selv udvikle AI-løsninger som er nyttige i økonomiske analyser
]
...
- Store modeller
- Gode til mange ting
- Data bliver sendt et eller andet sted hen
  + *eller* kræver infrastruktur
- 100'ere milliarder parametrer
...
### BERT, CANINE, etc.
- 'Små' modeller
- Gode til specialiseret opgaver
- Kan klares på en bærbar og trænes lokalt
- 100'ere millioner parametre
- **Har bedre performance i deres kontekst** (Butcher & Martini, 2024)
]

.footnote[
.pull-left-wide[
.small123[Bucher, M. J. J., & Martini, M. (2024). Fine-tuned ‘small’ LLMs (still)significantly outperform zero-shot generative AI models in text classification. Retrieved from https://arxiv.org/abs/2406.08660]
]
]
...
suppressWarnings({
  tmp = read_csv2("CPH_hisco_codes_clean.csv", col_types = "c")
})
rownames(tmp) = NULL
...
tmp = tmp %>%
  rowwise() %>% 
  mutate(
    occ1 = strsplit(occ1, " ")[[1]][1]
  ) %>% 
  distinct(occ1, hisco1) %>% 
  ungroup() %>% 
  sample_n(13547, replace = TRUE) 
...
.small123[
*Københavns begravelsesprotkoller, Link Lives, Rigsarkivet*
]

---
# HISCO codes
- Kommer fra ISCO (International Standard Classification of Occupations) 
- Minder om DISCO
- Leuwen, Maas, Miles (2002) fra ISCO68  
- Hirarkisk 
...
- Neuralt netværk trænet over ~20 dage
]
]
...
.pull-right-narrow[
- Baseret på en masse bidrag
- Data kommer stadig ind
]


---
# Staldtips til træning af neurale netværk
.pull-left[
### To slags løsninger:
1. Lær alt overfladisk
2. Lær beskæftigelser som concept (som mennesker)

.red[
- Bedre performance jo mere man kan skubbe mod 2
]
...
### Hvordan?
.small123[
- Gør livet svært for modellen
- Gør data dårligere

- Indsæt tilfældige bogstaver
- Dropout: Drop tilfældige 10% af 'neuroner' i træning
- Etc.
]
]
...
---
# Danske folketællinger (1787-1901)

.pull-left-narrow[
- Danske folketællinger indeholder folks beskæftigelse
- 13.7 millioner observationer
- Vi kan standardisere det hele automatisk på en eftermiddag
- Offentligt tilgængelig 

- Det kan vi lave meget med:
  + Skamløse egne eksempler:
    + [A Perfect Storm: First-Nature Geography and Economic Development](https://arxiv.org/abs/2408.00885)
    + [Tracks to Modernity: Railroads, Growth, and Social Movements in Denmark](https://arxiv.org/abs/2502.21141)
]
...
.pull-left-narrow[
- Alt sammen pakket ind i et simpelt python library 
]
...
# Konklusion
.pull-left[
- Det plejede at tage måneder og kræve uendelig mængder studentermedjælper
- Nu kan vi gøre det på en bærbar i løbet af nogle timer
- Mulighed for bedre kvalitet end før
- Model og modelkode er open source 
]
...
- OccCANINE guide YouTube: https://youtu.be/BF_oNe-sABQ?si=Ef1YrkK43Ln_IHJS
- Paper på arXiv: https://arxiv.org/abs/2402.13604 
]
...
- 10000 observations in minutes (rather than 27 hours)

- Small language model, OccCANINE:
