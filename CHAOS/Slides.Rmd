...
- Archives are **rich in occupations**, but **sparse in individual incomes**.
...
.footnote[
.chaosred[*1. and 2. causes systematic bias* (Saavedra, Twinam, 2020; Inwood, Minns and Summerfield, 2019)] 
]

--
#### .chaosred[*We address all of these to some extend*]
...
# PPI style bias correction example
...
.footnote[
.chaosred[*There are versions of this that generalises into regression*]
]
