...
/* Centered “pull” block (useful for a single centered column) */
.pull-center {
  margin-left: auto;
  margin-right: auto;
  width: 44%;           /* match pull-left/pull-right; adjust as you like */
  float: none;          /* explicitly not floating */
  display: block;
}

/* Clear after a centered pull block, analogous to your pull-right rule */
.pull-center ~ p {
  clear: both;
}

/* Optional variants to mirror your wide/narrow helpers */
.pull-center-wide {
  margin-left: auto;
  margin-right: auto;
  width: 66%;
...
- Økonom - PhD d. 25. september 2023
...
- IB student fra Nyborg Gymnasium i 2013 - 13 år siden. 
...
--
.pull-right-narrow[
***... Og i dag skal det handle om Store Bededag:***
]
...
2.500.000 personer 'strukturelt' beskæftiget

]

.pull-right[
**Scenarie 2 - store bededag afkaffet:**  
2.500.000 .highlight[\+ 8500] personer 'strukturelt' beskæftiget
]
...
---
# Hvordan ved de at det er 8500 mere?
...
.pull-left-wide[
#### Man burde bruge et *bedre* instrument - også for helligdage. Men det er svært.
]
...
.pull-left-wide[
.small123[
**Note:** Og AI ser ud til vedblivende at være dårlig til den slags. På Ocoen-studiet lærer man at lave løsninger sammen med nyeste teknikker indenfor statistik, machine learning og data science. 
]
]
]
