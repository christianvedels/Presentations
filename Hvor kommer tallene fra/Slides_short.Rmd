...
ggsave("Figures/Offentlige_indtaegter.png", plot = p1, width = 4, height = 3)
ggsave("Figures/Offentlige_saldo.png", plot = p2, width = 4, height = 3)
ggsave("Figures/Beskaetigelse.png", plot = p3, width = 4, height = 3)
```
...
--
.pull-right[
1. Kan man gøre sådan?
2. Hvad er usikkerheden?
]
