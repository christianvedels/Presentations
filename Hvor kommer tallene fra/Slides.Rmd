...
- Underviser i alt fra machine learning fag til indledende statistik og økonomisk historie
...
ggsave("Figures/Arbejdstid.png", plot = p1, width = 6, height = 4)
```
...
## '[A perfect storm*](https://raw.githack.com/christianvedels/Guest_Lectures_and_misc_talks/main/Bruddet_paa_Aggertangen/Bruddet_paa_Aggertangen.html#1)'-projektet: 
