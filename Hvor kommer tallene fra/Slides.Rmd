...
**Spørgsmål**
1. Hvad betyder det?
2. Hvad er en *'strukturel offentlig saldo'*?
3. Hvordan ved de, at det er 8500 mere? 
4. Hvad er usikkerheden på det tal? 
5. Hvordan har de beregnet det? 
6. Hvordan *bør* man beregne det?
]

.pull-right[
**Svar (til uddybning)**
1. Det er et *kausalt postulat*
2. Budgettet i de lange løb 
3. Det gør de ikke 
4. Meget stor 
5. Med en ringe metode
6. Med en bedre metode / Overhoved ikke
]
...
# data0 = read_csv2("Data/DST_OFF3_indtaegter_i_alt.csv", col_names = c("Year", "Indtaegter"))

# # Create a base plot
# base_plot = ggplot(data0, aes(x = Year, y = Indtaegter)) +
#   geom_line() +
#   labs(title = "Public Revenue Over Time")
# 
# # Plot 2: Public revenue versus time with a trend line
# plot2 = base_plot +
#   geom_smooth(method = "lm", se = FALSE, color = "red") +
#   labs(title = "Public Revenue Over Time with Trend Line")
# 
# # Plot 3: Public revenue with the trendline subtracted out
# plot3 = base_plot +
#   geom_smooth(method = "lm", se = FALSE, color = "red") +
#   geom_line(data = data0 %>% mutate(Indtaegter = Indtaegter - predict(lm(Indtaegter ~ Year, data0))), color = "blue") +
#   labs(title = "Public Revenue with Trend Line Subtracted")
# 
# # Combine plots 2 and 3 into a list
# plot_list = list(base_plot, plot2, plot3)
# 
# # Animate the transition between the plots
# anim = gganimate::transition_states(
#   state = seq_along(plot_list),
#   transition_length = 3,
#   state_length = 3
# )
# 
# # Render the animation
# anim_plot = base_plot + gganimate::enter_fade() +
#   gganimate::exit_fade()
# anim_plot
